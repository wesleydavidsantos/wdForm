 ...
 * 
 * @author Wesley David
 * @modificado 24/02/2013
 * @implements Atributo $saveIgnore
 * 
 * 
 * 
 * 
...
class Model
{
    ...
    /**
     * Atributo IGNORE usado para não gerar erro ao inserir dados com restrições de chaves
     * 
     * @author Wesley David
     * @date 24/02/2013
     * @var String
    */
     ...
     * @date 24/02/2013
     * @update O parametro $validate pode receber a String 'ignore' usado para evitar erros na inserção de dados com restrições de chave 
     * 
	 */
	public function save($validate=true)
	{
        ...
        if( strtolower( $validate ) == 'ignore' ){
            $this->saveIgnore = true;
            $validate = true;
        } 
	...
	private function insert($validate=true)
	{
		...
		$table = static::table(); 
        $table->ignore = $this->saveIgnore; /* Implementado ação */
    ...
    /**
     * @author Wesley David Santos
     * @obs Retorna a última SQL usada
    */
    public static function getLastSql(){
        return static::table()->last_sql;
    }
